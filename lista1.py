...
tempo = float(input("tempo da viagem em horas: "))
 velocidade_média = float(input("velocidade média em km/h: "))
 print(f'(L= D/12): {tempo})
 print(f'(D=T*V): {velocidade})
...
prestação vencida = int(input('valor da prestação vencida'))
